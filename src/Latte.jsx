      ...
      <section className='flex flex-col justify-center items-center gap-8 h-96 large bg-slate-50 rounded-md'>
        ...
        <div className='flex justify-center items-center gap-4'>
          ...
          <div className='flex flex-col gap-4'>
            <span className='text-black text-lg font-medium'>Cod Interno: {codInt}</span>
            <span className='text-black text-lg font-medium'>Cod Online: {codOn}</span>
            <span className='text-black text-lg font-medium'>Precio por semana: {priceWeek}</span>
            <span className='text-black text-lg font-medium'>Precio por mes: {priceMonth}</span>
            <span className='text-black text-lg font-medium'>Estado: {status}</span>
